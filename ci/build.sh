...
# TODO: reuse artefacts
ARTIFACT=dependencies-$(git --git-dir ${ZUUL_PROJECT_SRC_DIR}/.git rev-parse HEAD).tar.xz
...
${ZUUL_PROJECT_SRC_DIR}/submodules/sysrepo
ninja-build
ctest --output-on-failure
popd
...
tar -C ~/target -cvJf ${BUILD_DIR}/${ARTIFACT} .
